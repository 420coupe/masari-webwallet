...
# Cron task / Process
Precomputed data are build by another process. This process will call the Aeon daemon and compute blocks into chunks of blocks to reduce network latency.
